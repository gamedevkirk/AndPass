...
> [!WARNING]
> This project is a work in progress. Basic red-only functionality is present, but the project lacks testing on a wide range of devices. Currently only tested on a Pixel 9 running Graphene OS. 
